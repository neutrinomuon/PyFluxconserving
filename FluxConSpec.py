...
'''
    ...
    def time():
        ...
        interpolation_names = ['Linear  Table Indexing    ' , 'Cubic Spline                   ', 'One Dimensional Spline ', 'Hermite Interpolation     ', 'Akima Interpolation        ', 'Simple Interpolation       ', 'Indexer Interpolation      ','Polynomial Interpolation','Akima  Spline Scipy', 'Cubic Spline Scipy','Spectral Resampling','Numpy Interpolation'] 
        N_slows = len(interpolation_names)
